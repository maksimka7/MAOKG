...
public class ReadingImageFromFile {
	...
	public static void loadBitmapImage(String filename) throws IOException
	{
		...
		// створення обєкту типу ReadingHeaderFromBitmapImage
		HeaderBitmapImage hbi = new HeaderBitmapImage();
		// сворення об'єкту типу HeaderBitmapImage
		hbi = reading.Reading(reader1);
		// у об'єкт типу HeaderBitmapImage записуємо результат роботи методу читання заголовку файлу
		pr = reading.pr;
