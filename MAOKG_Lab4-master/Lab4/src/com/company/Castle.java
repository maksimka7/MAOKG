...
public class Castle implements ActionListener {
    ...
    private void setCylinderTowers(){
        TransformGroup cylinderTower2 = CastleBody.getCylinderTower(0.8f, -0.8f, 0.80f);
        treeTransformGroup.addChild(cylinderTower2);
        TransformGroup cylinderTower3 = CastleBody.getCylinderTower(0.8f, 0.8f, -0.80f);
        treeTransformGroup.addChild(cylinderTower3);
        TransformGroup cylinderTower4 = CastleBody.getCylinderTower(0.8f, -0.8f, -0.80f);
        treeTransformGroup.addChild(cylinderTower4);
        TransformGroup cylinderTower5 = CastleBody.getCylinderTower(0.8f, 0.8f, 0.80f);
        treeTransformGroup.addChild(cylinderTower5);

        TransformGroup centralCylinderTower = CastleBody.getCylinderTower(1f, 0, 0);
        treeTransformGroup.addChild(centralCylinderTower);
    }
