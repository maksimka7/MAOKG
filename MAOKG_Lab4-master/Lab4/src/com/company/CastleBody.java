...
public class CastleBody {
    ...
    private static Appearance getBodyAppearence() {
        TextureLoader loader = new TextureLoader("source_folder\\stones.jpg",  new
                Container());
    ...
    private static Appearance getCylTowersAppearence() {
        TextureLoader loader = new TextureLoader("source_folder\\stones.jpg", "LUMINANCE", new Container());
        Texture texture = loader.getTexture();
        texture.setBoundaryModeS(Texture.WRAP);
        texture.setBoundaryModeT(Texture.WRAP);
        texture.setBoundaryColor(new Color4f(0.0f, 1.0f, 1.0f, 0.0f));
